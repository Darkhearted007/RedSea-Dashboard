          ...
          {portProfile ? (
            <div className="p-5 space-y-4">
              ...
              {portProfile.notes.length > 0 && (
                <div>
                  <p className="text-xs text-[#4a6080] uppercase tracking-widest mb-2">Intelligence Notes</p>
