...
- [Supabase migration complete](supabase-migration.md) — All Supabase reads/writes migrated to Replit PostgreSQL; API routes return snake_case to match legacy frontend contract.
