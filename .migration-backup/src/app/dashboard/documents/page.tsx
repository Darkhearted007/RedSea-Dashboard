...
export default function DocumentsPage() {
  ...
  const processFile = useCallback(async (file: File) => {
    ...
    try {
      // Extract text content if it's a text-based document
                ...
                <div className="space-y-2">
                  {result.flags.map((flag, i) => (
                    <div
                      ...
                      style={{
                        backgroundColor:
                          CONFIDENCE_COLORS[flag.confidence as keyof typeof CONFIDENCE_COLORS] + "08",
                        borderColor:
                          CONFIDENCE_COLORS[flag.confidence as keyof typeof CONFIDENCE_COLORS] + "33",
                      }}
                    >
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span
                          ...
                          style={{
                            color: CONFIDENCE_COLORS[flag.confidence as keyof typeof CONFIDENCE_COLORS],
                          }}
                        >
                          {flag.confidence}
                        </span>
              ...
              .map((entry) => (
                <div key={entry.documentId} className="px-6 py-3 flex items-center justify-between">
                  ...
                  <span
                    className="text-xs font-mono"
                    style={{
                      color: entry.result.isTampered ? "#ff0033" : "#00ff88",
                    }}
                  >
